...
import rot_func_moon
import threading
from threading import Thread

#################################
# Leonardo Sattler Cassara
# Telescope Control - Moon
#################################
...
def rec():
    ...
    rlb.recordDVM(filename='moon.npz', recordLength=t_s)
...
def track():
    ...
    while time.localtime()[3] < n:
        ...
        if time.localtime()[4]+time.localtime()[5]/60. == t:
            ...
            rlb.pntHome()
            rlb.pntTo(rot_func_moon.convert()[1]*180./np.pi, rot_func_moon.convert()[0]*180./np.pi)
