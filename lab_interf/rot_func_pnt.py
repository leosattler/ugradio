...
##### Working with input ######
    ...
    x = 5.+(35./60.)+(17.3/3600) # RA of Orion, in hours
    x = x*15*np.pi/180. # RA of Orion, in radians

    y = -(5. + 23.*0.0167 +28.*0.000277) # DEC of Orion, in degrees
    y = y*np.pi/180 # DEC of Orion, in radians
